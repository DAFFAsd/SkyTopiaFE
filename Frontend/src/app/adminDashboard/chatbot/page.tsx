    ...
    return (
        <div className="space-y-4 flex flex-col h-[calc(100vh-100px)] md:h-[calc(100vh-80px)]">
            <div className="flex-shrink-0">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <h1 className="font-rammetto text-2xl md:text-3xl font-bold text-brand-purple">
                        SkyBot Admin - Asisten Jadwal
                    </h1>
                </div>
                <p className="text-sm text-gray-600 mt-2">
                    Gunakan chatbot untuk membuat jadwal dengan mudah. Contoh: &quot;Buatkan jadwal Matematika hari Senin jam 09:00-10:00&quot;
                </p>
            </div>
            ...
            <div className="flex-1 flex flex-col lg:flex-row gap-6 overflow-hidden bg-white rounded-xl shadow-sm border border-gray-200 relative">
                <div className={`
                    w-full lg:w-1/3 flex flex-col bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-full
                        ...
                        {messages.length === 0 && !isLoadingHistory && (
                            <div className="flex flex-col justify-center items-center h-full opacity-60">
                                ...
                                <p className="text-gray-500 text-center max-w-md text-sm">
                                    Halo Admin! Saya SkyBot asisten penjadwalan. Saya bisa membantu Anda membuat jadwal kegiatan dengan mudah.
                                </p>
                                <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-md">
                                    <p className="text-xs font-semibold text-blue-900 mb-2">💡 Contoh perintah:</p>
                                    <ul className="text-xs text-blue-800 space-y-1">
                                        <li>• &quot;Buatkan jadwal Matematika hari Senin jam 09:00-10:00 dengan guru Ibu Siti&quot;</li>
                                        <li>• &quot;Buat jadwal Bahasa Inggris untuk tanggal 5 Desember 2025&quot;</li>
                                        <li>• &quot;Jadwalkan Olahraga di Lapangan pada hari Rabu pukul 10:00&quot;</li>
                                    </ul>
                                </div>
                            </div>
                        )}
