...
const { requireAdmin, requireAdminOrTeacher, requireParent, requireAnyRole } = require('../middleware/roleCheck');
...
router.get('/', authMiddleware, requireAdminOrTeacher, childController.getAllChildren);
